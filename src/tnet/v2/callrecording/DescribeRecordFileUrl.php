...
/**
 * 6.3.2. 查看通话录音地址
 * @link [third api doc]https://develop.clink.cn/develop/api/cc.html#_查看通话录音地址
 *
 * @package mysticzap\tinetclink\tnet\v2\callrecording
 */
class DescribeRecordFileUrl extends Api
{
    /**
    ...
    public $apiName = "查看通话录音地址";
    public $api = '/cc/describe_record_file_url';
